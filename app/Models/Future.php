...
{
    //
    protected $fillable = ['client_id', 'coin_pair_id', 'client_wallet_future_id', 'leverage', 'estimated_force_parity', 'margin', 'open_interest', 'current_price', 'manual_closing_allowed',
    'reached_stop_loss_difference', 'income', 'rate_of_return'];
