<template>
    <v-app>
        <v-container>
            <trading-vue :data="this.$data" title-txt="BTCUSD" :width="this.width" :height="this.height"></trading-vue>
        </v-container>
  ...
  <script>
      ...
      components: { TradingVue },
          ...
          created()
          {
                this.ticker = setInterval(this.updateChart, 2000)
